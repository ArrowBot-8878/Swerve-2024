...
public class MAXSwerveModule {
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    m_drivingSparkMax = new CANSparkMax(drivingCANId, com.revrobotics.CANSparkLowLevel.MotorType.kBrushless);
    m_turningSparkMax = new CANSparkMax(turningCANId, com.revrobotics.CANSparkLowLevel.MotorType.kBrushless);
    ...
    m_DriveFeedforward = new SimpleMotorFeedforward(0.244, 0.391);
  }
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    m_drivingPIDController.setReference(optimizedDesiredState.speedMetersPerSecond, CANSparkMax.ControlType.kVelocity, 0, m_DriveFeedforward.calculate(optimizedDesiredState.speedMetersPerSecond));
